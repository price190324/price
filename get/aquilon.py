...
def glob():
    ...
    start_url="https://akvilon.kz/c/sukhie-stroitelnye-smesi-i-gruntovki/"
...
def details(url):
    try:       
        ...
        # Поиск информации
        try:
            # Категория //*[@id="__layout"]/div/div[1]/div[2]/div[1]/ol/div/ul/div[3]/li/a/span
            #kategoriya = driver.find_element(By.XPATH, "//*[@id=\"__layout\"]/div/div[1]/div[2]/div[1]/ol/div/ul/div[3]/li/a/span")
            kategoriyas = driver.find_elements(By.CLASS_NAME, "link")
            #for kategoriya in kategoriyas:
            #    print(kategoriya.text)            
            row.append(kategoriyas[2].text)
            print(kategoriyas[2].text)
        except Exception as exception:
            row.append("kategoriya")
            #kategoriya = "kategoriya"
            print(exception)
        try:
            # Название //*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[3]/h1
            #nazvanie = driver.find_element(By.XPATH, "//*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[3]/h1")
            ...
            print(exception)
        try:
            #Описание //*[@id="__layout"]/div/div[1]/div[1]/div[3]/div[3]/div[7]
            #description = driver.find_element(By.XPATH, "//*[@id=\"__layout\"]/div/div[1]/div[1]/div[3]/div[3]/div[7]")
            description = driver.find_element(By.CLASS_NAME, "description")
            if description != None:
                row.append(description.text.replace("\n\n", "\n"))
            ...
            print(exception)
        try:
            #Цена //*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[3]/div[3]/div[1]/div[1]
            #cena = driver.find_element(By.XPATH, "//*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[3]/div[3]/div[1]/div[1]")
            cena = driver.find_element(By.CLASS_NAME, "base-price-block")
            if cena != None:
            ...
            print(exception)
        try:
            # Артикул //*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[3]/div[1]/span
            #artikul = driver.find_element(By.XPATH, "//*[@id=\"__layout\"]/div/div[1]/div[2]/div[2]/div[3]/div[1]/span")
            artikul = driver.find_element(By.CLASS_NAME, "codes")
            if artikul != None:
            ...
            print(exception)
        try:
            # Фотография //*[@id="__layout"]/div/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div/span/img
            #img = driver.find_element(By.XPATH, "//*[@id=\"__layout\"]/div/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div/span/img")
            img = driver.find_element(By.CLASS_NAME, "src-image")
...
def parsing(url):
    try:
        ...
        # Набор ссылок на карточки, пример ссылки на карточки https://akvilon.kz/p/shpatlyevka-gipsovaya-alinex-glatt-25-kg_1/
        my_links = []
        for link in links:
            if str(link.get_attribute('class'))=="global-link":
        ...
        for i in range(len(my_links)):     
            try:
                ...
                if (len(glob.data) % 1000 == 0):
                    ...
                    excel.export_to_excel(HEADER, glob.data, "aquilon.kz." + str(current_date_time) + ".xls")
...
def run():    
    try:
        ...
        # Вызов: заголовок таблицы, данные, название файла
        current_date_time = datetime.now().strftime('%Y%m%d%H%M%S')
        excel.export_to_excel(HEADER, glob.data, "aquilon.kz.range(" +str(glob.start_page) + "-" + str(glob.finish_page) + ")_" +str(current_date_time) + ".xls")
        # Экспорт в БД
...
# Создается новый класс AquilonhWindow котрый наследуется от класса QMainWindow. 
class AquilonhWindow(QMainWindow):
    def __init__(self):
        try:
            super().__init__()
            ...
            # Заголовок окна
            self.setWindowTitle("aquilon.kz")
            ...
            self.lineEdit_start_url.setText("https://akvilon.kz/c/sukhie-stroitelnye-smesi-i-gruntovki/")
            ...
            self.spinBox_finish_page.setValue(6)
